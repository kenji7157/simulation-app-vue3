...
// 電力会社の選択肢を生成
export function getCompanyOptions(area: areaTypes): SelectOption<companyTypes>[] {
...
// 契約容量の選択肢を生成
export function getAmpsOption(simulationData: ISimulation): SelectOption<string>[] {
